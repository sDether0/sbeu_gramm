...
namespace SBEU.Gramm.DataLayer.Migrations
{
    ...
    [Migration("20220727123404_againlike3")]
    partial class againlike3
    {
            ...
            modelBuilder.Entity("SBEU.Gramm.DataLayer.DataBase.Entities.NLike", b =>
                {
                    ...
                    b.Property<string>("LikeObjectId")
                        .IsRequired()
                        .HasColumnType("text");

                    b.Property<string>("NCommentaryId")
                        .HasColumnType("text");
                    ...
                    b.HasIndex("LikeObjectId");

                    b.HasIndex("NCommentaryId");
            ...
            modelBuilder.Entity("SBEU.Gramm.DataLayer.DataBase.Entities.NLike", b =>
                {
                    ...
                    b.HasOne("SBEU.Gramm.DataLayer.DataBase.Entities.NContentObject", "LikeObject")
                        .WithMany("Likes")
                        .HasForeignKey("LikeObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("SBEU.Gramm.DataLayer.DataBase.Entities.NCommentary", null)
                        .WithMany("Likes")
                        .HasForeignKey("NCommentaryId");
