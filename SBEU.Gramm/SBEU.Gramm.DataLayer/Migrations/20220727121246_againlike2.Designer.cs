...
namespace SBEU.Gramm.DataLayer.Migrations
{
    ...
    [Migration("20220727121246_againlike2")]
    partial class againlike2
    {
            ...
            modelBuilder.Entity("SBEU.Gramm.DataLayer.DataBase.Entities.NCommentary", b =>
                {
                    ...
                    b.OwnsMany("SBEU.Gramm.DataLayer.DataBase.Entities.NLike", "Likes", b1 =>
                        {
                            b1.Property<string>("LikeObjectId")
                                .HasColumnType("text");
                            ...
                            b1.HasKey("LikeObjectId", "Id");

                            b1.HasIndex("AuthorId");

                            b1.ToTable("Commentaries_Likes");

                            b1.HasOne("SBEU.Gramm.DataLayer.DataBase.Entities.XIdentityUser", "Author")
                                .WithMany()
                                .HasForeignKey("AuthorId")
                                .OnDelete(DeleteBehavior.Cascade)
                                .IsRequired();

                            b1.WithOwner("LikeObject")
                                .HasForeignKey("LikeObjectId");

                            b1.Navigation("Author");

                            b1.Navigation("LikeObject");
                        });
                    ...
                    b.OwnsMany("SBEU.Gramm.DataLayer.DataBase.Entities.NLike", "Likes", b1 =>
                        {
                            ...
                            b1.ToTable("ContentObjects_Likes");
